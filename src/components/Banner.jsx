        ...
        <section className="md:w-[80%] w-full mx-auto md:px-0 px-2 md:py-16 py-6">
            <div className="flex md:flex-row flex-col gap-2">
                ...
                <div className="md:w-[50%] w-full flex flex-col justify-center items-center space-y-5 relative">
                    {loading ? (
                        <div className="md:w-[420px] w-[304px] md:h-[420px] h-[304px] bg-gray-300 animate-pulse rounded-full"></div> // Skeleton loader
                    ) : (
                        <Image src={bannerImage} alt="banner image" width={420} height={510} />
                    )}
                    ...
                    {
                        loading ? 
                        <div className="w-[226px] h-[70px] bg-gray-300 animate-pulse absolute top-10 right-30"></div>
                        :
